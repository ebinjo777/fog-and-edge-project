...
ENDPOINT = os.getenv("AWS_ENDPOINT_URL", "http://localhost:4590")
REGION = os.getenv("AWS_REGION", "eu-west-1")
TABLE_NAME = os.getenv("TABLE_NAME", "ska-readings")

SENSOR_TYPES = ["snowpack_depth_cm", "snow_temp_c", "wind_speed_kmh", "seismic_vibration_mg", "lift_chair_count"]
